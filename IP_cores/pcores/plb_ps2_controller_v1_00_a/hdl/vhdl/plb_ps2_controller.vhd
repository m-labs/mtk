------------------------------------------------------------------------------
-- plb_ps2_controller.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          plb_ps2_controller.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Sat Jan 12 14:37:12 2008 (by Create and Import Peripheral Wizard)
...
library plb_ps2_controller_v1_00_a;
use plb_ps2_controller_v1_00_a.user_logic;
...
end entity plb_ps2_controller;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plb_ps2_controller is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb_ps2_controller_v1_00_a.user_logic
    generic map
    (
    ...
    (
      ...
      key_data     => key_data,
      key_clk      => key_clk,
      mouse_data_i => mouse_data_i,
      mouse_data_o => mouse_data_o,
      mouse_data_t => mouse_data_t,
      mouse_clk_i  => mouse_clk_i,
      mouse_clk_o  => mouse_clk_o,
      mouse_clk_t  => mouse_clk_t,
