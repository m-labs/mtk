...
# /net/user/r1/unix/alles/projekte/genode/genode_start/genode-fx/trunk/EDK_projects/ml507/system.mhs
# The software specification of the system is in file :
# /net/user/r1/unix/alles/projekte/genode/genode_start/genode-fx/trunk/EDK_projects/ml507/system.mss
...
dope_test_program: $(DOPE_TEST_OUTPUT) 

$(DOPE_TEST_OUTPUT) : $(DOPE_TEST_SOURCES) $(DOPE_TEST_HEADERS) $(DOPE_TEST_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/dope_test_compiler.opt
	@mkdir -p $(DOPE_TEST_OUTPUT_DIR) 
	$(DOPE_TEST_CC) $(DOPE_TEST_CC_OPT) $(DOPE_TEST_SOURCES) -o $(DOPE_TEST_OUTPUT) \
	$(DOPE_TEST_OTHER_CC_FLAGS) $(DOPE_TEST_INCLUDES) $(DOPE_TEST_LIBPATH) \
	$(DOPE_TEST_CFLAGS) $(DOPE_TEST_LFLAGS) 
	$(DOPE_TEST_CC_SIZE) $(DOPE_TEST_OUTPUT) 
	@echo ""

dope_test_programclean:
	rm -f $(DOPE_TEST_OUTPUT) 
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(DOPE_TEST_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(DOPE_TEST_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)
