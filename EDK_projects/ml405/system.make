...
# Project:/home/xilinx/src/genode-fx.hg/genode-fx/EDK_projects/ml405/system.xmp
#
...
$(DOPE_TEST_OUTPUT) : 
	@echo "Sw App dope_test: Neither C-sources specified, nor marked for BRAM initialization. Not compiling elf file"
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(TESTAPP_MEMORY_OUTPUT) $(TESTAPP_PERIPHERAL_OUTPUT) $(DOPE_TEST_OUTPUT) 
	@echo "*********************************************"
	@echo "Creating system ace file"
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(TESTAPP_MEMORY_OUTPUT) $(TESTAPP_PERIPHERAL_OUTPUT) $(DOPE_TEST_OUTPUT)  -target ppc_hw  -ace $(SYSTEM_ACE)
